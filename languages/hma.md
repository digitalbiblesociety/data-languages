...
glottolog_classification: "Hmong-Mien > Hmongic > Nuclear Hmongic-Ho Ne > Nuclear Hmongic > West Hmongic > Greater Chuanqiandian > Mashan > Southern Mashan Hmong"
wikidata_id: Q12953560
translations:
  - translation_iso: ara
    name: لغة مهمونغ ماشان الجنوبية
    auto: true
  - translation_iso: ben
    name: দক্ষিণ মাশান হমোং
    auto: true
  - translation_iso: deu
  ...
  - translation_iso: fra
    ...
    auto: true
  - translation_iso: hin
    name: दक्षिणी माशान ह्मोंग
    auto: true
  - translation_iso: ind
    name: Bahasa Mashan Hmong Selatan
    auto: true
  - translation_iso: jpn
    name: 南部麻山フモン語
  - translation_iso: kor
  ...
  - translation_iso: por
    ...
    auto: true
  - translation_iso: rus
    name: южный машан хмонгский язык
    auto: true
  - translation_iso: spa
