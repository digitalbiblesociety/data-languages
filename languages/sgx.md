...
glottolog_classification: "Sign Language > L1 Sign Language > LSFic > ASLic > Sierra Leone Sign Language"
wikidata_id: Q7511448
wikipedia_url: "https://en.wikipedia.org/wiki/Sierra_Leonean_Sign_Language"
translations:
  - translation_iso: ara
    name: سييرا ليون لغة الإشارة
    auto: true
  - translation_iso: ben
    name: সিএর্রা লেওনে ইশারা ভাষা
    auto: true
  - translation_iso: deu
  ...
  - translation_iso: hin
    ...
    auto: true
  - translation_iso: ind
    name: Bahasa Isyarat Sierra Leone
    auto: true
  - translation_iso: jpn
    name: シエラレオネ手話
  - translation_iso: kor
  ...
  - translation_iso: rus
    name: сиерра леонейский жестовый язык
    auto: true
  - translation_iso: spa
